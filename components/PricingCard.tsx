...
export default function PricingCard({ title, description, benefits, isOutlined, children,button, mode }: PropsWithChildren<PricingCardProps>) {
...
const Wrapper = styled.div<{ isOutlined?: boolean }>`
  ...
  width: 50rem;
  //margin: 0 auto;
  background: rgba(255, 255, 255, 0.3);//var(--cardBackground));
